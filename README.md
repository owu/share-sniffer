...
The project provides automated packaging scripts located in the `/package` directory, supporting packaging for Windows and Linux platforms.

### 5.1 Packaging Script Description

| Script Name | Platform | Description |
|---------|------|------|
| `build-windows.ps1` | Windows | PowerShell script for building Windows platform GUI executable files |
| `build-linux.sh` | Linux | Bash script for building Linux platform GUI installation packages |
...
cd package
chmod +x build-linux.sh build-android.sh build-cli-linux.sh
./build-linux.sh
...
- Automatically names generated files and outputs them to the `/package` directory
...
1. Download the latest installation package `ShareSniffer.v0.1.0.linux-amd64.tar.xz` to any directory
...
tar -xJf ./ShareSniffer.v0.1.0.linux-amd64.tar.xz -C ./ShareSniffer.linux-amd64 
...
```
Download the latest share-sniffer-cli.v0.1.0.linux-amd64
...
```
Download the latest share-sniffer-cli.v0.1.0.windows-amd64.exe
...
![about](https://github.com/owu/share-sniffer/raw/unstable/screenshot/about.jpg)

### 7.2 Detection Interface

![check](https://github.com/owu/share-sniffer/raw/unstable/screenshot/check.jpg)

### 7.3 Result Interface

![result](https://github.com/owu/share-sniffer/raw/unstable/screenshot/result.jpg)
...
|------|------|------|
| `error` | int | Error code, 0 indicates success, non-zero indicates failure |
